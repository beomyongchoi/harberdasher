...
var MarkerOverlappingRecognizer = function(opts) {
    this._options = $.extend({
        ...
        intersectNoticeTemplate: '<div style="border:solid 3px #00592D;background-color:#fff;padding:5px;min-width:200px;">There are {{count}} starbucks stores.</div>',
        intersectList: true,
        intersectListTemplate: '<div style="border:solid 3px #00592D;background-color:#fff;padding:5px;min-width:180px;">'
            + '<ul style="list-style:none;margin:0;padding:0;">'
            + '{{#repeat}}'
            + '<li style="list-style:none;margin:0;padding:0;"><a href="#" style="color:#00592D;text-decoration:none;">{{order}}. {{name}}</a></li>'
            + '{{/#repeat}}'
            + '</ul>'
            + '</div>'
    }, opts);
